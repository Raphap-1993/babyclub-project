    ...
    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-4 space-y-2">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="mt-2 sm:mt-6 rounded-xl bg-white px-4 py-2 text-sm font-semibold uppercase tracking-wide text-black transition hover:scale-[1.01] disabled:opacity-70"
        >
