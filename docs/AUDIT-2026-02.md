...
| 7) CI/CD y gobernanza | Rojo | `package.json:13`, `pnpm check-types` falla por task inexistente (2026-02-13) | Gate tecnico definido en la documentacion del proyecto no se cumple completamente en scripts/pipeline actuales. |
