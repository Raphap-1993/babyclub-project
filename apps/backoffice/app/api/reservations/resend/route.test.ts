...
describe("POST /api/reservations/resend", () => {
  ...
  it("reenvia confirmación para ticket-only aunque todavía no haya unidades emitidas", async () => {
    ...
    expect(payload.ticketEmailError).toBeNull();
    expect(payload.reservationEmailError).toBeNull();
