      ...
      <CardHeader>
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
          ...
          <Select
            ...
            className="w-full text-neutral-900 [color-scheme:light] sm:w-64"
